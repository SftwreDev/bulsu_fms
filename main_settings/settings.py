...
SECRET_KEY = 'django-insecure-qrbaqq5t)2$199tewjgfr-u9zo=f$tu)zfrn=m^=vafp5*y7#q'
...
CSRF_TRUSTED_ORIGINS = [ 'https://ehealthwebapp-25cvs.ondigitalocean.app',  'https://*.ondigitalocean.app', 'http://localhost:8000']


CSRF_COOKIE_DOMAIN = 'ondigitalocean.app'

CORS_ORIGIN_WHITELIST = (
    'https://ehealthwebapp-25cvs.ondigitalocean.app',
    'http://localhost:8000'
)
